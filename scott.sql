...
--
INSERT INTO TABLE_NOTNULL(LOGIN_ID,LOGIN_PWD) VALUE('TEST_01','TEST_01');  
...
INSERT INTO TABLE_NOTNULL VALUES('TEST_01','TEST_01','010-1234-5678');
SELECT * FROM TABLE_NOTNULL;
ALTER TABLE TABLE_NOTN  ULL MODIFY(TEL NOT NULL);
...
--
SELECT OWNER,CONSTRAINT_NAME,CONSTRAINT_TYPE,TABLE_NAME FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'TABLE_NOTNULL2';

--
ALTER TABLE TABLE_NOTNULL2 RENAME CONSTRAINT TBLNN_TEL_NN TO TBLNN_TEL_NN2;
SELECT * FROM TABLE_NOTNULL2;
...
INSERT INTO TABLE_UNIQUE VALUES('TEST_ID_01','PWD081','010-5232-2054');
SELECT * FROM TABLE_UNIQUE;

-- 무결성 제약 조건에 위배된다. 위에 중복되는것이 잇음.
INSERT INTO TABLE_UNIQUE VALUES('TEST_ID_01','PWD082','010-5232-2054');

-- UNIQUE 제약조건에는 NULL 삽입 가능
INSERT INTO TABLE_UNIQUE VALUES(NULL,'PWD082','010-5232-2055');


CREATE TABLE TABLE_UNIQUE2(
    LOGIN_ID VARCHAR2(20) CONSTRAINT TBLUNQ_LGNIN_UNO UNIQUE,
    LOGIN_PWD VARCHAR(20) CONSTRAINT TBLUNQ_LGNPWD_UNO NOT NULL,
    TEL VARCHAR2(20));
...
-- 무결성 제약 조건(C##SCOTT.SYS_C008406)에 위배
INSERT INTO TABLE_PK
...
CREATE TABLE TABLE_PK2(
    ...
    LOGIN_PWD VARCHAR(20)CONSTRAINT TBLPK2_LGNPWD_PK NOT NULL,
    TEL VARCHAR2(20));
...
-- 만약 ON DELETE CASCADE  안한다면 자식데이터 지우고 부모 데이터 지워야함
